...
help:
	...
	@echo "  make frontier-high-d Run the complete high-D frontier packet suite"
...
high-d-formalization:
	PYTHONPATH=python $(PYTHON) python/scripts/high_dim_formalization_bridge.py --strict
	PYTHONPATH=python $(PYTHON) -m pytest -q python/tests/test_high_dimensional.py
