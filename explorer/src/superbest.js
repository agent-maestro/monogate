...
export const DAG_BENCHMARKS = [
  ...
  },
  {
    ...
    treeBest:46,
    dagBest:20,
    shared:["normalizer", "exp(q*k1)", "exp(q*k2)", "exp(q*k3)"],
    note:"Strongest current frontier: repeated logits, exponentials, and softmax normalizer.",
  },
  {
    ...
    treeBest:26,
    dagBest:12,
    shared:["sigmoid(x)", "1+exp(-x)", "exp(-x)"],
    note:"Reuses sigmoid value and denominator across value-plus-derivative pattern.",
  },
  {
    id:"rational_shifted_basis",
    label:"shared shifted denominator",
    family:"rational_shared_denominator",
    eml:126,
    treeBest:22,
    dagBest:14,
    shared:["x+a"],
    note:"Reuses shifted denominator across reciprocal, log, and exp terms.",
  },
  {
    id:"polynomial_basis_degree5",
    label:"shared polynomial basis",
    family:"polynomial_basis_reuse",
    eml:163,
    treeBest:16,
    dagBest:10,
    shared:["x*x", "x*x*x*x"],
    note:"Reuses x^2 and x^4-like basis terms across polynomial features.",
  },
];
