...
| nguyen-1 | beam | 6 | 2.264e-02 | ✗ | `eml(eml(x, eml(1.0, 1.0)), eml(eml(x, em` | 0.3 |
...
| nguyen-3 | beam | 5 | 1.108e-02 | ✗ | `eml(eml(x, eml(1.0, 1.0)), eml(1.0, eml(` | 0.3 |
| nguyen-4 | mcts | 4 | 1.518e-01 | ✗ | `eml(x, eml(1.0, eml(eml(x, 1.0), 1.0)))` | 0.0 |
| nguyen-4 | beam | 6 | 7.440e-02 | ✗ | `eml(eml(x, eml(1.0, 1.0)), eml(1.0, eml(` | 0.3 |
...
| nguyen-6 | beam | 3 | 3.128e-02 | ✗ | `eml(x, eml(1.0, eml(x, 1.0)))` | 0.3 |
...
| nguyen-8 | beam | 4 | 1.554e-01 | ✗ | `eml(1.0, eml(eml(1.0, eml(1.0, 1.0)), x)` | 0.6 |
| keijzer-6 | mcts | 3 | 3.310e-01 | ✗ | `eml(1.0, eml(eml(1.0, x), 1.0))` | 0.0 |
