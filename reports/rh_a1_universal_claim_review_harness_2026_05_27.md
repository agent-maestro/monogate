...
|---|---|---|---|---|---|
| `eml-softplus-general-speed-claim` | `performance` | `runtime_bakeoff_local` | `blocked_public_claim` | `private` | run broader runtime bakeoff before making any public performance claim |
...
| `r11-compiler-lowering-correctness` | `compiler_correctness` | `formal_proof_skeleton_open` | `blocked_public_claim` | `private` | discharge open proof-skeleton obligations before compiler correctness claims |
...
| `r12-generated-stubs-validate-on-fixtures` | `generated_stub_validation` | `formal_proof_skeleton_open` | `candidate_only` | `candidate` | keep as candidate packet until required validators pass |
