...
|---|---|---|
| `machlib_witness_index_log1p_shifted_boundary` | `checked_witness_recorded_private` | record_as_private_checked_witness |
| `log1p_shifted_guard_boundary` | `shifted_positive_domain_boundary_required` | keep_shifted_positive_guard_and_boundary_controls |
| `log1p_shifted_runtime_control_guardrail` | `protected_log_and_log1p_runtime_controls_required` | keep_protected_log_and_log1p_as_runtime_controls |
| `advantage_lab_log1p_shifted_boundary` | `runtime_control_remains_protected_log_and_log1p` | do_not_add_runtime_advantage_row_without_new_runtime_evidence |
| `public_atlas_log1p_shifted_boundary` | `held_private` | require_human_copy_review_before_public_change |
