...
| 3 | `r11-compiler-lowering-correctness` | `medium` | 48 | `R10E formal compiler proof skeleton` | `formal_compiler_proof` |
...
| 8 | `r12-generated-stubs-validate-on-fixtures` | `low` | 28 | `R10E formal compiler proof skeleton` | `formal_compiler_proof` |
