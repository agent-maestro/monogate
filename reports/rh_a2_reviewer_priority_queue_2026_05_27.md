...
|---:|---|---|---:|---|---|
| 1 | `command-cockpit-robust-to-private-leakage` | `high` | 72 | `RT-A2 local RAMPART adapter` | `rampart_redteam_packet` |
| 2 | `pm-a1-profitable-agent-claim` | `high` | 68 | `PM-A1B calibration ledger` | `pm_a1_forecast_packet` |
| 3 | `electronics-voltage-divider-hardware-observed` | `high` | 65 | `EE-A2 live capture packet` | `live_capture_packet` |
| 4 | `eml-softplus-general-speed-claim` | `high` | 64 | `R10B runtime bakeoff` | `r10_cost_stability` |
| 5 | `r11-compiler-lowering-correctness` | `medium` | 48 | `R10B runtime bakeoff` | `runtime_bakeoff` |
...
| 9 | `r12-generated-stubs-validate-on-fixtures` | `low` | 28 | `R10B runtime bakeoff` | `r12_generated_stub_packet` |
| 10 | `oph-correct-theory-of-everything-claim` | `low` | 23 | `X1 external theory claim decomposition` | `claim_decomposition` |

## Summary

- Queue items: `10`
- Top claim: `command-cockpit-robust-to-private-leakage`
- Top sprint: `RT-A2 local RAMPART adapter`
