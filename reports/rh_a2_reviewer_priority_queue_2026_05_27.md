...
| 2 | `eml-softplus-general-speed-claim` | `high` | 64 | `R10B runtime bakeoff` | `r10_cost_stability` |
| 3 | `r11-compiler-lowering-correctness` | `medium` | 48 | `R10B runtime bakeoff` | `runtime_bakeoff` |
