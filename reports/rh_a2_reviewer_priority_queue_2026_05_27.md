...
| 3 | `r11-compiler-lowering-correctness` | `medium` | 48 | `R10C scoped semantic proof` | `scoped_semantic_proof` |
...
| 8 | `r12-generated-stubs-validate-on-fixtures` | `low` | 28 | `R10C scoped semantic proof` | `scoped_semantic_proof` |
