...
| `rust_if_return_clamp_v0` | `rust` | `if_return_clamp` | `blocked` | `rust_if_expression_unsupported` | line 1: expected kw 'else', got kw 'if' |
...
- Blocked fixtures: `1`
- Unexpected passes: `4`
- Later-phase pass cases: `c_if_early_return_relu_v0, c_if_else_clamp_v0, c_ternary_select_v0, rust_if_expr_relu_v0`
