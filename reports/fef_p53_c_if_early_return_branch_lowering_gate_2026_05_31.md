...
|---|---|---:|---|---:|---:|
| `c_if_early_return_relu_v0` | `c` | 5 | `pass` | 0.000e+00 | 0.000e+00 |
| `c_if_early_return_relu_v0` | `rust` | 5 | `pass` | 0.000e+00 | 0.000e+00 |

## Summary

- Selected C if early-return lowering pass: `True`
- Source cases: `1`
- Re-ingest packets: `2`
- Packet samples: `10`
