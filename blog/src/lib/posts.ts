...
const ASTRO_POSTS: Post[] = [
  ...
  { href: '/blog/complexity-census', slug: 'complexity-census', title: 'The EML Complexity Census', tag: 'observation', date: '2026-04-19', desc: '23 elementary functions classified by EML depth, each row with what its depth rests on: a Lean theorem, a construction, an argument, or nothing yet.' },
  { href: '/blog/deml-is-incomplete', slug: 'deml-is-incomplete', title: 'DEML Is Incomplete', tag: 'conjecture', date: '2026-04-19', desc: 'Why deml(x,y) = exp(−x) − ln(y) should not construct exp(+x) or neg(x): an argument on paper with a gap, no Lean proof, and an exhaustive search over 862,118 trees.' },
  { href: '/blog/depth-6-phase-transition', slug: 'depth-6-phase-transition', title: 'The Depth-6 Phase Transition', tag: 'observation', date: '2026-04-19', desc: 'Built from 1, EML values stay real through depth 4. At depth 5 every non-real value has Im = −π exactly; at depth 6 there are 13,600 distinct imaginary parts. A structural phase transition.' },
  ...
  { href: '/blog/near-miss', slug: 'near-miss', title: '0.99999524: The Near-Miss', tag: 'research', date: '2026-04-19', desc: 'How close can an EML tree get to i? The closest depth-6 value is 4.76×10⁻⁶ away. The tan(1) obstruction once given is not a proof, and a depth-7 tree gets its imaginary part within 7.9×10⁻¹² of 1.' },
  ...
  { href: '/blog/pumping-lemma', slug: 'pumping-lemma', title: 'A Pumping Lemma for EML Trees?', tag: 'conjecture', date: '2026-04-19', desc: 'Do depth-k trees have at most 2^k zeros? The proof offered does not work. Up to 8 internal nodes the most sign changes found was 3, too few sizes to show a growth rate.' },
  { href: '/blog/weierstrass-theorem', slug: 'weierstrass-theorem', title: 'The EML Weierstrass Theorem', tag: 'conjecture', date: '2026-04-19', desc: 'The claim that EML trees are dense in C([a,b]), and a four-step argument for it that has a gap; no Lean proof.' },
