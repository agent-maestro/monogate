...
const ASTRO_POSTS: Post[] = [
  ...
  { href: '/blog/complexity-census', slug: 'complexity-census', title: 'The EML Complexity Census', tag: 'observation', date: '2026-04-19', desc: '23 elementary functions classified by EML depth, each row with what its depth rests on: a Lean theorem, a construction, an argument, a computation, or nothing yet.' },
