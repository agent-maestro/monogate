...
const ASTRO_POSTS: Post[] = [
  ...
  { href: '/blog/deml-is-incomplete', slug: 'deml-is-incomplete', title: 'DEML Is Incomplete', tag: 'theorem', date: '2026-04-19', desc: 'Why deml(x,y) = exp(−x) − ln(y) should not construct exp(+x) or neg(x): an argument on paper with a gap, no Lean proof, and an exhaustive search over 861,952 trees.' },
