...
const ASTRO_POSTS: Post[] = [
  ...
  { href: '/blog/deml-is-incomplete', slug: 'deml-is-incomplete', title: 'DEML Is Incomplete', tag: 'theorem', date: '2026-04-19', desc: 'Why deml(x,y) = exp(−x) − ln(y) should not construct exp(+x) or neg(x): an argument on paper with a gap, no Lean proof, and an exhaustive search over 862,118 trees.' },
  ...
  { href: '/blog/weierstrass-theorem', slug: 'weierstrass-theorem', title: 'The EML Weierstrass Theorem', tag: 'theorem', date: '2026-04-19', desc: 'The claim that EML trees are dense in C([a,b]), and a four-step argument for it that has a gap; no Lean proof.' },
