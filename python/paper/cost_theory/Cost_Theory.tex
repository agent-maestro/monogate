...
% Date: 2026-04-20
% Status: SUPERSEDED by Cost_Theory_Complete.tex
%
% NOTE (2026-04-20): This document covers T34–T39 (sessions COST-1 through
% COST-9).  It has been superseded by Cost_Theory_Complete.tex, which
% consolidates all R1–R14 results (T34–T43, 13 theorems/propositions,
% empirical validation on 187+ equations across 12+ domains).
% For new work, refer to Cost_Theory_Complete.tex.
...
Addition $x + y$ (all real $x,y$) & \texttt{add} & 2 & ADD-T1 (SuperBEST v5) \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Taylor series (sin, cos, exp)   & 6  & $8N - 2$ \\
Shannon entropy $-\sum p_i \ln p_i$ & 4  & $6N - 2$ \\
Softmax cross-entropy           & 5  & $7N - 2$ \\
PK multi-compartment sum        & 8  & $10N - 2$ \\
Fourier partial sum             & 4  & $6N - 2$ \\
\bottomrule
\end{tabular}
\end{center}
