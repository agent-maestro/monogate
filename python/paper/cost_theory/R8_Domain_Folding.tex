...
\begin{table}[h]
\centering
\caption{SuperBEST v3 addition costs by domain.}
\label{tab:add-costs}
\smallskip
\begin{tabular}{@{}lcc@{}}
\toprule
\textbf{Routing path} & \textbf{Condition} & \textbf{Cost ($n$)} \\
\midrule
Positive-domain addition & $x > 0$ and $y > 0$ provably & $3n$ \\
General-domain addition  & at least one operand sign unknown & $11n$ \\
\bottomrule
\end{tabular}
\end{table}
...
The distinction between $3n$ and $11n$ is the largest single-operator cost gap
