...
such addition (v3/v4).
\emph{In SuperBEST v5 (ADD-T1): $c_{\texttt{add}}=2$ for all real inputs;
domain-folding saving for addition is 0 (all additions cost 2n regardless).}
\end{theorem}
...
Softmax cross-entropy               & 5  & $7N - 2$  & D \\
Taylor series (sin, cos, exp)       & 6  & $8N - 2$  & A \\
Fourier partial sum                 & 4  & $6N - 2$  & A \\
PK multi-compartment sum            & 8  & $10N - 2$ & A \\
\bottomrule
\end{tabular}
\end{table}
