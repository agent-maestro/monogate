...
but cost 2 nodes via EML routing (SuperBEST v5, ADD-T1); transcendentals cost 1 in both systems.
\end{table}
...
The dominant per-call expense is \textbf{add} (2n, SuperBEST v5), equal to
subtraction and multiplication (2n each); transcendentals cost 1n each.
The positive/general domain split for addition is eliminated (ADD-T1).
