...
def test_fef_p15_records_partial_typecheck_with_sorry_boundary():
    ...
    assert summary["typecheckBlockedCount"] == 1
    assert "blocked_generated_name_ambiguity" in summary["typecheckWithSorryStatuses"]
...
def test_fef_p15_keeps_proof_and_correctness_claims_false():
    ...
    assert gates["all_selected_lean_typecheck_with_sorry"] == "blocked"
