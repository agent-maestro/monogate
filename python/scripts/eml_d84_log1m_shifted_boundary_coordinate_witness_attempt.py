#!/usr/bin/env python3
"""EML-D84 log1m shifted boundary coordinate MachLib witness attempt."""
...
from scripts import eml_d83_log1m_shifted_boundary_coordinate_feasibility_packet as d83  # noqa: E402

DATE = "2026-06-04"
STAMP = DATE.replace("-", "_")
SCHEMA_VERSION = "monogate.eml_log1m_shifted_boundary_coordinate_witness_attempt.v0"
...
def build_payload(atlas_gate_path: Path) -> dict[str, Any]:
    feasibility = d83.build_payload(atlas_gate_path)
    d83.validate_payload(feasibility)
    ...
    summary = {
        ...
        "sourceDuplicateLog1pBlockPreserved": feasibility["summary"]["duplicateLog1pBlockPreserved"],
        ...
        "publicReady": False,
        "nextArtifact": "EML-D85 log1m shifted checked-witness private surface review",
    ...
    return {
        ...
        "attemptType": "eml_log1m_shifted_boundary_coordinate_witness_attempt_v0",
        "artifactId": "eml-d84-log1m-shifted-boundary-coordinate-witness-attempt",
        "status": STATUS,
        "decision": "checked_log1m_shifted_boundary_coordinate_witness",
        "date": DATE,
        "sourceFeasibilityPacket": feasibility["artifactId"],
...
def validate_payload(payload: dict[str, Any]) -> None:
    ...
    if payload["sourceFeasibilityPacket"] != "eml-d83-log1m-shifted-boundary-coordinate-feasibility-packet":
        raise ValueError("D84 must consume D83")
    ...
    if summary["sourceProposedMachlibName"] != "MachLib.Real.log1m_shifted_boundary_coordinate_witness":
    ...
    if summary["machlibName"] != "MachLib.Real.log1m_shifted_boundary_coordinate_witness":
    ...
    if summary["nextArtifact"] != "EML-D85 log1m shifted checked-witness private surface review":
...
def build_evidence(payload: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "artifactType": "eml_log1m_shifted_boundary_coordinate_witness_attempt",
        "validationStatus": "pass",
        "semanticStrength": "private_checked_guarded_machlib_witness_no_runtime_or_public_claim",
        "source": f"python/results/eml_d84_log1m_shifted_boundary_coordinate_witness_attempt/eml_d84_log1m_shifted_boundary_coordinate_witness_attempt_{STAMP}.json",
        "summary": payload["summary"],
        "claimFlags": dict(CLAIM_FLAGS),
        "nonClaims": list(NON_CLAIMS),
    }
...
def build_feed(payload: dict[str, Any]) -> dict[str, Any]:
    return {
        "feedId": "eml_d84_log1m_shifted_boundary_coordinate_witness_attempt_feed",
        "date": DATE,
        ...
        "nextAction": "Run EML-D85 as a private checked-witness surface review; do not promote public copy.",
        "claimFlags": dict(CLAIM_FLAGS),
    }
...
def build_outputs(
    ...
    result_path = out_dir / f"eml_d84_log1m_shifted_boundary_coordinate_witness_attempt_{STAMP}.json"
    report_path = report_dir / f"eml_d84_log1m_shifted_boundary_coordinate_witness_attempt_{STAMP}.md"
    evidence_path = evidence_dir / "eml_d84_log1m_shifted_boundary_coordinate_witness_attempt.json"
    feed_path = command_feed_dir / f"eml_d84_log1m_shifted_boundary_coordinate_witness_attempt_feed_{STAMP}.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=ROOT / "python/results/eml_d84_log1m_shifted_boundary_coordinate_witness_attempt")
...
def main() -> int:
    ...
    print("EML_D84_LOG1M_SHIFTED_BOUNDARY_COORDINATE_WITNESS_ATTEMPT_OK")
    return 0
