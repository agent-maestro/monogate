...
def style_for_packet(packet: dict[str, Any]) -> tuple[str, list[str], str]:
    ...
    elif family_id == "stable_sigmoid":
        primary = "eml_native"
        rationale = "The bounded transition is generated by an exponential boundary, while runtime still requires a stable branch form."
...
def build_evidence_packet(payload: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "reviewHighlights": [
            ...
            "Classifies eight existing Forge/eFrog export packets without changing the compiler or decompiler.",
...
def validate_payload(payload: dict[str, Any], packets: list[dict[str, Any]]) -> None:
    ...
    summary = payload["summary"]
    if summary["stylePacketCount"] != 8:
        raise ValueError("expected eight style packets")
