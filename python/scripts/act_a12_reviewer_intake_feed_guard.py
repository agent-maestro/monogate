#!/usr/bin/env python3
"""ACT-A12 reviewer intake feed guard packet."""
...
from scripts import act_a11_reviewer_intake_snapshot as a11  # noqa: E402

DATE = "2026-06-02"
STAMP = DATE.replace("-", "_")
SCHEMA_VERSION = "monogate.alpha_gamma_reviewer_intake_feed_guard.v0"
EVIDENCE_SCHEMA_VERSION = "monogate.evidence_public_packet.v0"
STATUS = "ACT_A12_REVIEWER_INTAKE_FEED_GUARD_PASS"

EXPECTED_SOURCE_FEED_ID = "act_a11_reviewer_intake_snapshot_feed"
EXPECTED_SOURCE_STATUS = "ACT_A11_REVIEWER_INTAKE_SNAPSHOT_PASS"
EXPECTED_SOURCE_DECISION = "record_reviewer_intake_snapshot_no_production_validator_no_soundness_claim"
...
CLAIM_FLAGS = {
    "reviewer_intake_feed_guard_recorded": True,
    "act_a11_reviewer_intake_snapshot_consumed": True,
...
def build_payload(atlas_gate_path: Path) -> dict[str, Any]:
    ...
    summary = {
        "sourceReviewerIntakeSnapshot": source["artifactId"],
        ...
        "reviewerIntakeFeedGuardRecorded": True,
        "actA11ReviewerIntakeSnapshotConsumed": True,
        ...
        "publicReady": False,
        "nextAction": "GB-VIS-A12 private adapter intake feed guard or ACT-A13 reviewer promotion hold gate without public promotion.",
    ...
    return {
        ...
        "packetType": "alpha_gamma_reviewer_intake_feed_guard_v0",
        "artifactId": "act-a12-reviewer-intake-feed-guard",
        "status": STATUS,
        "decision": "record_reviewer_intake_feed_guard_no_production_validator_no_soundness_claim",
        "date": DATE,
        "sourceReviewerIntakeSnapshot": source["artifactId"],
...
def validate_payload(payload: dict[str, Any]) -> None:
    ...
    if payload["sourceReviewerIntakeSnapshot"] != "act-a11-reviewer-intake-snapshot":
        raise ValueError("ACT-A12 must consume ACT-A11")
    ...
    for key in [
        "reviewerIntakeFeedGuardRecorded",
        "actA11ReviewerIntakeSnapshotConsumed",
        "sourceFeedRebuilt",
...
def build_evidence(payload: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "artifactType": "alpha_gamma_reviewer_intake_feed_guard",
        "validationStatus": "pass",
        "semanticStrength": "private_alpha_gamma_reviewer_intake_feed_guard_no_production_validator_no_soundness_proof",
        "source": f"python/results/act_a12_reviewer_intake_feed_guard/act_a12_reviewer_intake_feed_guard_{STAMP}.json",
        "summary": payload["summary"],
        "claimFlags": dict(CLAIM_FLAGS),
        "nonClaims": list(NON_CLAIMS),
    }
...
def build_feed(payload: dict[str, Any]) -> dict[str, Any]:
    return {
        "feedId": "act_a12_reviewer_intake_feed_guard_feed",
        "date": DATE,
...
def build_outputs(out_dir: Path, report_dir: Path, evidence_dir: Path, command_feed_dir: Path, atlas_gate_path: Path) -> dict[str, Any]:
    ...
    result_path = out_dir / f"act_a12_reviewer_intake_feed_guard_{STAMP}.json"
    report_path = report_dir / f"act_a12_reviewer_intake_feed_guard_{STAMP}.md"
    evidence_path = evidence_dir / "act_a12_reviewer_intake_feed_guard.json"
    feed_path = command_feed_dir / f"act_a12_reviewer_intake_feed_guard_feed_{STAMP}.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=ROOT / "python/results/act_a12_reviewer_intake_feed_guard")
...
def main() -> int:
    ...
    print("ACT_A12_REVIEWER_INTAKE_FEED_GUARD_OK")
    return 0
